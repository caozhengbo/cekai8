    ...
    export default {
        ...
        methods: {
            ...
            getreportdetail(index){
                    this.$api.getUIReportsdetail(index,{
                    params: {
            ...
            handleCurrentChange(val) {
                this.$api.getUIReportsPaginationBypage({
                    params: {
            ...
            handleDelReports(index) {
                this.$confirm('此操作将永久删除该测试报告，是否继续?', '提示', {
                    ...
                    this.$api.deleteUIReports(index,{params:{project:this.$route.params.id}}).then(resp => {
            ...
            delSelectionReports() {
                if (this.selectReports.length !== 0) {
                    this.$confirm('此操作将永久删除勾选的测试报告，是否继续?', '提示', {
                        ...
                        this.$api.deleteAllUIReports(this.selectReports,{project:this.$route.params.id}).then(resp => {
